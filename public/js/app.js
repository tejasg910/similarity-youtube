...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n                <p>".concat(menuItem.pizza.name, " - ").concat(menuItem.quantity, " pcs </p>\n            ");
    }).join("");
  }
...
/* harmony import */ var _showNotification__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./showNotification */ "./resource/js/showNotification.js");
/* harmony import */ var _showNotification__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_showNotification__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _stripe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./stripe */ "./resource/js/stripe.js");
...
if (paymentForm) {
  paymentForm.addEventListener("submit", function (e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_4__["default"].post("/order", formObject).then(function (res) {
      console.log(res);
      if (res.data.success) {
        (0,_showNotification__WEBPACK_IMPORTED_MODULE_2__.showNotification)(res.data.message);
        setTimeout(function () {
          window.location.href = "/order";
        }, 1000);
      } else {
        (0,_showNotification__WEBPACK_IMPORTED_MODULE_2__.showNotification)("something went wrong");
      }
    })["catch"](function (err) {
      console.log(err);
      (0,_showNotification__WEBPACK_IMPORTED_MODULE_2__.showNotification)(err.message);
    });
  });
}
...
/***/ "./resource/js/showNotification.js":
/*!*****************************************!*\
  !*** ./resource/js/showNotification.js ***!
  \*****************************************/
/***/ ((module) => {
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var stripe, elements, style, card, cardElement;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          // );
          stripe = Stripe("pk_test_51MyIicSH0DotAFf8fTlBtCtrDg3spc3GSVxtWOKmCt2jq4FC463HIrZd0DYv6JqJddPTgY0Kbi46jE10WAOXFsUS00ZfCZTEDJ"); // var elements = stripe.elements({
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkreal_time_pizza_app"] = self["webpackChunkreal_time_pizza_app"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/app"], () => (__webpack_require__("./resource/scss/app.scss")))
